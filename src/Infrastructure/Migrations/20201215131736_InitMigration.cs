    ...
    public partial class InitMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupLanguageTools", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupTutorials", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LanguageTools", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LanguageTools_GroupLanguageTools_GroupId",
                        column: x => x.GroupId,
                        principalTable: "GroupLanguageTools",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LanguageTools_Technologies_TechnologyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Title = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(290)", maxLength: 290, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HtmlContent = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GroupId = table.Column<int>(type: "int", nullable: false),
                    LanguageToolId = table.Column<int>(type: "int", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tutorials_GroupTutorials_GroupId",
                        column: x => x.GroupId,
                        principalTable: "GroupTutorials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tutorials_LanguageTools_LanguageToolId",
                        column: x => x.LanguageToolId,
                        principalTable: "LanguageTools",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArticleComment_Comment_CommentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TutorialImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TutorialImages_Tutorials_TutorialId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LanguageTools_GroupId",
                table: "LanguageTools",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_LanguageTools_TechnologyId",
                table: "LanguageTools",
                column: "TechnologyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TutorialImages_TutorialId",
                table: "TutorialImages",
                column: "TutorialId");

            migrationBuilder.CreateIndex(
                name: "IX_Tutorials_GroupId",
                table: "Tutorials",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_Tutorials_LanguageToolId",
                table: "Tutorials",
                column: "LanguageToolId");
        }
